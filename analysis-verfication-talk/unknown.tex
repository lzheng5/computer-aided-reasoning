...
\begin{frame}
  ...
  \begin{itemize}
  \item \invisible<-1>{\text{\mex{M.f} should be some unknown value, \unknown}}
  ...
  \invisible<-5>{Does \unknown\ really mean \textbf{any value}?}
  ...
  \begin{columns}[t]
    \begin{column}{0.4\textwidth}
      ...
      \begin{array}{@{}ll@{}}
        ...
        \mex{\kw{let} add1 = \kw{fun} n \codearr n + 1 \kw{in}} \\
        \mex{\kw{let} g = \altcolor{3-4}{blue}{\kw{fun} m \codearr 2 * (add1 m)} \kw{in}} \\
...
\begin{frame}
  ...
  \begin{itemize}
  \item \invisible<-1>{Can \mex{(M.f g)} ever return it?}
  \end{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
  \item Logical relations based soundness proofs \pause
