...
(test-dp (ramsey 3 3 5))  ; R(3,3)=6, so this should be UNSAT
(test-dp (ramsey 3 3 6))  ; R(3,3)=6, so this should be SAT
(test-dp (ramsey 4 4 18)) ; R(4,4)=18, so this should be SAT
